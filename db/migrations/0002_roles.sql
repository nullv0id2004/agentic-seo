...
grant select on projects, issues, reports, approvals, runs, gate_results, collection_gaps, agent_logs, content_briefs, keywords, pages, mentions, brand_rules, critical_rules, trend_events, audit_log, pitches to seo_console;
